...
Defects currently present in the API, recorded so the decision to fix them is
deliberate rather than accidental. Each entry gives the location, the impact
...
SMS, and renewal alerts only log. This is a development-only stand-in.
