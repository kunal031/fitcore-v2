 ...
 *
 * `GET /subscriptions/me` uses this when the member has no active plan: it
 * returns `success: false` with null data and HTTP 200 rather than a 404, and
 * the frontend relies on that.
 */
...
/** Compute `meta` from the raw counts, rounding page count up. */
