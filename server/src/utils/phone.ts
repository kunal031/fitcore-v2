 ...
 * this normaliser. An input it does not recognise is returned cleaned but
 ...
 *
 * Case-insensitive email lookups and member search put user input into a
 * `$regex`. Escaping keeps ordinary input matching as before while preventing
 * a stray `(` or `*` in a search box from throwing a regex error.
 */
