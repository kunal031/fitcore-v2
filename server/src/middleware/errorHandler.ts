 ...
 *
 * Converts every thrown error into the standard response envelope. Nothing
 * else in the codebase formats an error response.
 */
...
export function errorHandler(
  ...
  // Only the first issue is reported, with the message prefixed by its
  // location, so clients get one actionable field per response.
