 ...
 *
 * Razorpay is mocked by default: when the configured key is the
 * `.env.example` placeholder, orders get a synthetic id and signatures are not
 * checked. Supplying real credentials switches both on.
 *
